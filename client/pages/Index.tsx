...
const handleStartToday = () => {
  ...
  <Button onClick={handleStartToday} className="bg-white text-gray-700 font-semibold py-1 px-5 rounded-full hover:bg-blue-50 transition duration-200 text-s md:text-base">
